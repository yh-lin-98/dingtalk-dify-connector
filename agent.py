...
class Connector(dingtalk_stream.GraphHandler):
    ...
    async def process(self, callback: dingtalk_stream.CallbackMessage):
        ...
        sleep(1)
        self.reply_update(session_webhook, '1212121212121')
        sleep(1)
        self.reply_update(session_webhook, '12121212121211212121212121')
        sleep(1)
        self.reply_finish(session_webhook, '121212121212112121212121211212121212121')
